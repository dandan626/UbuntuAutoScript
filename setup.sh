...
echo ""
echo "#######################################################################"
echo "#                          Start to deploy envrionment!               #"
echo "#                                 V 1.0.1                             #"
echo "#######################################################################"
echo ""
echo ""
...
# install pkgs
building_list="subversion g++ zlib1g-dev build-essential git python rsync man-db "
building_list1="libncurses5-dev gawk gettext unzip file libssl-dev wget zip time curl sqlite3"
tools_list="tree "

apt_install_apps $building_list
apt_install_apps $building_list1
apt_install_apps $tools_list
